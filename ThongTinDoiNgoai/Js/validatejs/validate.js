...
(function(a, b, c) {
    ...
    e.extend = function(a) {
        ...
        presence: function(a, b) {
            if (b = e.extend({}, this.options, b), b.allowEmpty !== !1 ? !e.isDefined(a) : e.isEmpty(a)) return b.message || this.message || "không được để trống"
        },
        length: function(a, b, c) {
            if (e.isDefined(a)) {
                ...
                return e.isNumber(k) ? (e.isNumber(f) && k !== f && (d = b.wrongLength || this.wrongLength || "is the wrong length (should be %{count} characters)", j.push(e.format(d, {
                    count: f
                }))), e.isNumber(h) && k < h && (d = b.tooShort || this.tooShort || "quá ngắn (tối thiểu %{count} ký tự)", j.push(e.format(d, {
                    count: h
                }))), e.isNumber(g) && k > g && (d = b.tooLong || this.tooLong || "quá dài (tối đa %{count} ký tự)", j.push(e.format(d, {
                    count: g
        ...
        email: e.extend(function(a, b) {
            b = e.extend({}, this.options, b);
            var c = b.message || this.message || "không hợp lệ";
